...
public class TriggerItemViewModel extends SelectableItemViewModel implements LayoutHolder {
    ...
    TriggerItemViewModel(ChooseTriggerViewModel chooseTriggerViewModel, SensorItemViewModel sensor, TriggerType triggerType) {
    ...
    public int getItemLayoutId() {
        return R.layout.listitem_trigger;
    }
